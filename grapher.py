...
inTable = r'C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\LYRS_AND_TBLS_IN_MAPSERVICES'
outLines = r'C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\LINES'
outGDBObjectPoints = r'C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\POINTS_GDBOBJECTS'
outMapServicePoints = r'C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\POINTS_MAPSERVICES'
...
arcpy.Dissolve_management(outGDBObjectPoints_in_memory, r"C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\outGDBObjectPoints_in_memory_dissolved", ["datasourcefriendlyname", "datasetname"])
arcpy.Dissolve_management(outMapServicePoints_in_memory, r"C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\outMapServicePoints_in_memory_dissolved", ["serversitefriendlyname", "MAPSERVICENAME"])

#append the new dissolved point features
arcpy.Append_management(r"C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\outGDBObjectPoints_in_memory_dissolved", outGDBObjectPoints)
arcpy.Append_management(r"C:\Users\fimpe001\Documents\MGIS\GIS Programming\Project\MGIS.gdb\outMapServicePoints_in_memory_dissolved", outMapServicePoints)

# deal with the layout:
# possible outcomes:
    # arrange the GDB workspaces by type:
        # if WORKSPACEPATH ends in .gdb its a file geodatabase
        # if it ends in .sde it is an enterprise geodatabase
        # else it's something different.
    # arrange GDB objects alphabetically per workspace because that's how the user is used to seeing them 
