...
def get_lyr_or_tbl_props (lyr_or_tbl):
    ...
    it's value will be set to 'Failed to access this property'."""
    props = {}
    try:
...
#from a given string exract the portion between the two substrings '\\' and '.Mapserver'
function getMapServiceName(mxdFilepath):
